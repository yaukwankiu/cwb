...
url_date = "2013-06-11"   ###### <-------- UNCOMMENT THIS TO GET A SPECIFIC DATE  #########
...
def download(url, to_filename, url_date=url_date, folder="."):
    ################
...
if __name__ == '__main__':
    #main()
    #main(url_date='2013-06-14')
    #main(url_date='2013-06-15')
    #main(url_date='2013-06-16')
    main(url_date='2013-06-25')
    #main(url_date='2013-06-22')
    main(url_date='2013-06-26')
